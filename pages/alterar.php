...
<body>
    ...
    <div class="form-container">
        ...
        <div class="tab-content <?php echo ($activeTab === 'tab3') ? 'active' : ''; ?>" id="tab3">
            <!-- Conteúdo do formulário da aba "Autoria" -->
            <form name="autoria" method="POST" action="">
                <input type="hidden" name="form_type" value="autoria">
                <fieldset id="a">
                    <legend><b>Dados da Autoria</b></legend>
                    <p>Código do Autor: <input name="autor" type="number" placeholder="Código do Autor" required></p>
                    <p>Código do Livro: <input name="livro" type="number" placeholder="Código do Livro" required></p>
                    <p>Data de Lançamento: <input name="lancamento" type="date" required></p>
                    <p>Editora: <input name="editora" type="text" placeholder="Editora" required></p>
                </fieldset>
                <fieldset id="b">
                    <legend><b>Opções:</b></legend>
