            ...
            <div class="consultar">
                <form method="POST" action="">
                    ...
                    <fieldset>
                        ...
                        <input class="input-autoria" type="text" placeholder="Nome do livro" name="txtnome">
                        <br>
            ...
            <div class="consultar">
                <form method="POST" action="">
                    ...
                    <fieldset>
                        ...
                        <input class="input-autoria" type="text" placeholder="Nome do autor" name="txtnome">
                        <br>
                        <input class="botao" type="submit" value="Consultar" name="btnconsultar">
                    </fieldset>
                </form>
        ...
        <div class="consultar">
                <form method="POST" action="">
                    ...
                    <fieldset>
                        ...
                        <input class="input-autoria" type="text" placeholder="Código autor" name="txtcodautor">
                        <input class="input-autoria" type="text" placeholder="Código livro" name="txtcodlivro">
                        <br>
                        <input class="botao" type="submit" value="Consultar" name="btnconsultar">
                    </fieldset>
                </form>
